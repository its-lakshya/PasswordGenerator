let characterLengthJsValue=document.querySelector("#characterlength-js-value")
...
// })
function GivePassword(value1=false, value2=false, value3=false, value4=false, n){
    if(value1.checked==true && value2.checked==true && value3.checked==true && value4.checked==true){
        if(n%4==0){
            for(i=0;i<n/4;i++){
                let x=document.createElement("span")
                x = RandomNumbers(uppercase) + RandomNumbers(lowercase) + RandomNumbers(numbers) + RandomNumbers(symboles)
                screen.append(x)
            }
        }
        else if(n%2==0){
    ...
    else if(value1.checked==true && value2.checked==true && value3.checked==true){
        if(n%3==0){
            for(i=0;i<n/3;i++){
                let x=document.createElement("span")
                x=RandomNumbers(uppercase) + RandomNumbers(lowercase) + RandomNumbers(numbers)
                screen.append(x)
            }
        }
        else if(n%3==1){
    ...
    else if(value1.checked==true && value2.checked==true && value4.checked==true){
        if(n%3==0){
            for(i=0;i<n/3;i++){
                let x=document.createElement("span")
                x=RandomNumbers(uppercase) + RandomNumbers(lowercase) + RandomNumbers(symboles)
                screen.append(x)
            }
        }
        else if(n%3==1){
    ...
    else if(value1.checked==true && value3.checked==true && value4.checked==true){
        if(n%3==0){
            for(i=0;i<n/3;i++){
                let x=document.createElement("span")
                x=RandomNumbers(uppercase) + RandomNumbers(numbers) + RandomNumbers(symboles)
                screen.append(x)
            }
        }
        else if(n%3==1){
...
function ClearScreen() {
    screen.innerText=" "
    GivePassword(tickUppercase,tickLowercase,tickNumbers,tickSymboles,characterLengthJsValue.innerText)
